...
First of all we decided to generate smoothed histogram of Age - \ref{fig:age_dist}. We can observe that our sample is outbalanced by people at working age, what provides that further analysis will make sense.    

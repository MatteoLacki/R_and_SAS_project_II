  ...
  \newpage
    ...
    \subsection{Description of the selected database}
      ...
      \subsubsection{Region} 
        \SweaveInput{tex_Rnw/on_the_region_data.Rnw}
      \subsubsection{Income} 
        \SweaveInput{tex_Rnw/on_the_income_data.Rnw}
      \subsubsection{Education} 
        \SweaveInput{tex_Rnw/on_the_education_data.Rnw}
      \subsubsection{Disability} 
        \SweaveInput{tex_Rnw/on_the_disability.Rnw}
      \subsubsection{Grasp of English} 
        %\SweaveInput{tex_Rnw/on_the_grasp_of_english.Rnw}
